                            ...
                            <MyMeal
                              ...
                              onPress={() => router.push({
                                ...
                                params: {
                                  editId: meal.id,
                                  editName: meal.name,
                                  editCal: String(Math.round(meal.calories_per_100g || 0)),
                                  editProtein: String(Math.round(meal.protein_per_100g || 0)),
                                  editCarbs: String(Math.round(meal.carbs_per_100g || 0)),
                                  editFat: String(Math.round(meal.fat_per_100g || 0)),
